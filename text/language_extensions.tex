...
The \c{cheriot_interrupt_state} attribute (commonly used as a C++11 / C23 attribute spelled \c{cheriot::interrupt_state}) is applied to functions and takes an argument that is one of the following:
