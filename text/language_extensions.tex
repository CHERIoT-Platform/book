...
\amanda{I almost want to suggest a change in formatting so that code listings have boxes around them, not unlike functiondocs.  That would make it much clearer what part is code and what part is output/text, and less confusing when they interrupt text that ought to be kept together.}
