...
Phil> the term "untagged capability" doesn't immediately convey that what you get back is a capability that will fault if you try to use it - i.e. you have to use an is_valid() check on the result to see if teh call worked or not. 
