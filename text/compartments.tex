...
Phil>  Feels like something is missing here, you've only shown the declarations and body of the three, but it's not clear if there is a thread in each or an outer compartment that calls into each, etc 
