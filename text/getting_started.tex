...
lowRISC has produced an FPGA development board designed specifically for CHERIoT, called \href[src=https://github.com/lowRISC/sonata-system/releases]{Sonata}, using a slightly smaller version of the same FPGA as the Arty A7.
...
\figure[label=sonataexception,src=figures/sonata-exception-leds.jpg,alt=Sonata's CHERIoT exception LEDs]{CHERIoT exception LEDs on lowRISC's Sonata FPGA development board.}
