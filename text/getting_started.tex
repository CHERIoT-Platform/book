...
\end{console}
\amanda{In the PDF version, the line beginning with --mount is slightly too long and wraps.  I've edited it to avoid that, but you may wish to break it up differently.}
