...
CHERIoT provides spatial and memory safety and so there is a complementary aspect to memory allocation: What do you do when you manage memory incorrectly and CHERIoT catches the error?
