...
\amanda{In the PDF, this functiondoc appears after the start of the next section.}
...
\end{note}
\amanda{In the PDF, this note appears after the start of the next section.  It may be worthwhile to change the \section{} code to not start until the previous section has finished, if that is possible.}
...
\amanda{In this functiondoc, "Destroy the obj" should be "Destroy the object" to make it consistent with the other token_* functiondocs.}
...
\amanda{In this functiondoc, in the second paragraph, "EINVAL" should probably be "-EINVAL"}
