...
\codelisting[filename=examples/debug_helpers/example.cc,marker=log,label=lst:usingdebuglog,caption="Printing log messages with the debug log API."]{}
...
\end{console}
\phil{ The code in listing 60 doesn't match this output}
