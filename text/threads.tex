...
\amanda{In this functiondoc, the very last line should read "...safe to cache, as it will never change..."}
...
\end{note}
\amanda{This note comes in at a weird place.  Is it possible to change the "console" designation to not split in the middle?  It doesn't need to stay all on the same page, but notes or functiondocs coming in the middle of it make it more difficult to read.}
...
\amanda{In this functiondoc, in the first paragraph, "until this the thread" should be "until the thread"}

\functiondoc{futex_wake}
\amanda{In this functiondoc, in the second paragraph, "must be a valid, unsealed, pointer" should be "valid unsealed pointer"}
...
\amanda{In the PDF, this functiondoc appears after the beginning of the next section.}
...
\amanda{In this functiondoc, in the second paragraph, "The queue is has space" should be "The queue has space"}
...
\amanda{In this functiondoc, in the last paragraph, "This expected to be called" should be "This expects to be called" or "This is expected to be called"}
...
\amanda{In this functiondoc, in the PDF one of the lines overflows the box. I cannot tell why.}
