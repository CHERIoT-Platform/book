...
\amanda{I added the paratheses because "this" in the next line is ambiguous without them.  It's also valid to remove the paratheses and change "this" to be more explicit.}
