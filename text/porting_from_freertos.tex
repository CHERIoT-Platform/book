...
\begin{note}
The RTOS-provided thread pool is very simple.
...
If this wakes with timeout, it should invoke the first (`$$__cheri_callback$$`, see \ref{cheri_callback}) callback function in its queue.
