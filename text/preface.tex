...
It is a draft that contains most of the content that will go into the first edition, but has not yet completed technical review or copyediting.
As such, expect it to contain both factual and typographic errors.
...
Completing it was made possible by a grant from the Discribe Hub, under the umbrella of the Digital Security by Design (DSbD) Industrial Strategy Challenge Fund.
...
\begin{description}
	...
	\item[tag="4:"]{Photographer: marinbenc (marinbenc@sigmoid.social)}
	\item[tag="6:"]{Photographer: Asta Halkjær From (@ahfrom@fedi.ahfrom.synology.me), Cat: Betty Rambo.}
	\item[tag="7:"]{Photographer: vitaut (@vitaut@mastodon.social), Cat: Luna (no relation).}
	\item[tag="8:"]{Photographer: Michael McWilliams (@MichaelMcWilliams@mas.to).}
	\item[tag="9:"]{ Photographer: jarkman (@jarkman@chaos.social).}
