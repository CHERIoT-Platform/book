...
\amanda{The HTML version still has this numbered as 1.  The PDF doesn't, leading to chapter mis-matches between the versions.  On the whole, it makes more sense to me to not number the Preface, and it looks like that's your intent, but it's not actually working in the HTML version.}
...
\amanda{Should Marin's address have the leading @, or is this an email address?}
