...
\amanda{The HTML looks weird here, and could use a couple of newlines between the end of the table and the next paragraph.The PDF also looks weird for a different reason-- you start describing the items before the table appears.}
...
\amanda{Above, did you actually mean "local-global" or did you mean "load-global"?  If you meant it as "local-global" it should probably be reworded to "local/global" or "local or global store" or otherwise clarified to make it obvious you meant both.}
