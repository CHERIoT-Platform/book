...
\begin{note}
	...
	These follow similar escaping rules to C so, for example, \rego{"\\t"} is a string containing a tab character.
	You can avoid this processing by using backticks to designate a \keyword{raw string}.
	The Rego raw \rego{`\\t`} is a string containing a backslash and the letter 't'.
