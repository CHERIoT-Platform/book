...
\fixme{Rename alloc to allocator before we release RTOS v1.0!  Make sure to update this to the other alternative once done!}
...
A similar comprehnesion can extract the \json{quota} field from the decoded capabilities and then the built-in \rego{sum} function can add all of these together:
